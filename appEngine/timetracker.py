...
class MainPage(remote.Service):
    ...
    def mockDatabase(self, request):
        ...
        workday = Workday(checkin=datetime.strptime("2017-12-09 11:34:11.100", "%Y-%m-%d %H:%M:%S.%f"), checkout=datetime.strptime("2017-12-09 12:50:16.100", "%Y-%m-%d %H:%M:%S.%f"), employee=Employee(name="Julianna Dedon", email="Employee:[{jdedon0@unc.edu", image="http://dummyimage.com/214x197.png/dddddd/000000", role=1, status=False)).put()
        ...
        workday = Workday(checkin=datetime.strptime("2017-05-09 11:34:11.100", "%Y-%m-%d %H:%M:%S.%f"), checkout=datetime.strptime("2017-05-09 12:50:16.100", "%Y-%m-%d %H:%M:%S.%f"), employee=Employee(name="Julianna Dedon", email="Employee:[{jdedon0@unc.edu", image="http://dummyimage.com/214x197.png/dddddd/000000", role=1, status=False)).put()
